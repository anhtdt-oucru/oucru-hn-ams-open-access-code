...
echo ================================================
echo  Cap nhat Danh muc tham chieu - iSharp AMS
echo ================================================
echo.
...
echo.
echo Buoc 2/2 - Khoi chay ung dung Cap nhat Danh muc...
echo.
%RSCRIPT% -e "shiny::runApp('app_danh_muc.R', launch.browser = TRUE)"
pause
exit /b 0
